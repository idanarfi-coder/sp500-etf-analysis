...
הבהרה: פרויקט זה נבנה למטרות לימודיות ותרגול טכני בלבד (Python & SQL). אין לראות בכתוב, בגרפים או בניתוחים המוצגים המלצה להשקעה, ייעוץ פיננסי או תחליף לייעוץ מקצועי המתחשב בנתונים האישיים של כל אדם. כל המקבל החלטה על סמך המידע עושה זאת על אחריותו בלבד.
